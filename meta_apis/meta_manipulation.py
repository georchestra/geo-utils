...
class Meta_manipulation:
    ...
    def transform_metadata_from_geonode_to_gn(self, original_metadata, uuid, title, geoserver_link, feat_uuid, catalog_name,
    ...
    def transform_feature_from_geonode_to_gn(self, meta_feat, title, description, catalog_name, list_feat_detail=[]):
